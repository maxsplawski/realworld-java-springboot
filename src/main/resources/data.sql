...
VALUES (1, 'How to train your dragon', 'how-to-train-your-dragon', 'Ever wonder how?', 'Just stumble upon one!', now(),
        now());
INSERT INTO articles (user_id, title, slug, description, body, created_at, updated_at)
VALUES (2, 'Rocket science for dummies', 'rocket-science-for-dummies', 'Ever felt like going to space?',
